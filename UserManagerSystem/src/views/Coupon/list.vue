	...
	<div class="list">
		...
		<el-card class="box-card">
			<el-table :data="tableData" width="100%" :row-class-name="getRowStyle" :default-sort="{prop:'name'}">
				...
				<el-table-column header-align="left" width="140px" sortable
				 prop="name" label="name"> </el-table-column>
				<el-table-column header-align="left" width="160px" prop="game"
				 label="game"> </el-table-column>
				<el-table-column header-align="left" prop="price" label="price">
				</el-table-column>
				<el-table-column header-align="left" width="180px" prop="initial_amount"
				 label="initial_amount"> </el-table-column>
				<el-table-column header-align="left" prop="type" label="type">
				</el-table-column>
				<el-table-column header-align="left" prop="code" width="160px"
				 label="code"> </el-table-column>
				<el-table-column header-align="left" prop="meta" width="160px"
				 label="meta"> </el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			//删除
			handleDelete(item) {
				this.$delete("/admin/v1/content?type=Coupon&id=" + item.id, {}).then(
					response => {
						if (response.retCode == 0) {
							this.$message({
								message: '删除成功!',
			...
			queryTable() {
				this.$get('/admin/v1/contents?type=Coupon&offset=' + this.pageNum +
			...
			search() {
				...
				this.notSearch = false;
				this.$get('/admin/v1/contents/search?type=Coupon&q=' + this.keyword +
