  ...
  <div style="text-align: center">
    ...
    >
      <el-carousel-item
        ...
        :key="item.id"
        style="width: 50%; box-shadow: 0px 15px 20px -5px rgba(0, 0, 0, 0.3)"
      >
        <div
    ...
    <div class="img-contain">
      <a href="https://www.mcafeesecure.com/verify?host=egpal.com"
    ...
    <div class="choose-contain">
      ...
      >
        ...
        >
          ...
          <div
            class="text"
            style="font-size: 14px; text-align: left; color: #fff"
          >
        ...
        >
          ...
          <div
            ...
            style="font-size: 14px; text-align: left; color: #fff"
          >
          More than 95% of orders are processed successfully in less than 30 minutes.
        ...
        >
          ...
          <div
            ...
            style="font-size: 14px; text-align: left; color: #fff"
          >
           EGPAL ensures that buyers receive the item they ordered or get their money back.
          </div>
        </div>
         <div
          class="li"
...
.choose-contain {
  ...
  .contain {
    ...
    text-align: left;
    align-items:center;
    display: flex; background: rgba(242, 165, 6); width: 1200px;justify-content: space-around;
    .text{
      margin-top: 20px;
    }
  }
