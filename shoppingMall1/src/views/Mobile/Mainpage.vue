  ...
  <div class="main-page" style="text-align: center">
    <el-carousel v-if="bannerList" :interval="3000" height="200px">
      <el-carousel-item v-for="item in bannerList" :key="item.id">
        <div
          @click="item.link ? goNewBank(item.link) : goProduct(item, 1)"
          :style="
    ...
    <div class="img-contain">
      <a
        class="img-style"
        href="https://www.mcafeesecure.com/verify?host=egpal.com"
        ><img src="../../assets/image/home/img1.gif"
      /></a>
      <img class="img-style" src="../../assets/image/home/img2.gif" />
      <a
        class="img-style"
        href="https://transparencyreport.google.com/safe-browsing/search?url=www.egpal.com"
        ><img src="../../assets/image/home/img3.gif"
      /></a>
    ...
    <div class="item-contain">
      <div class="main-title hidden-style">
        {{ $t("language.mainPage.itemTitle") }}
      </div>
      <div class="tabs-wrapper" ref="tabsWrapper1">
        <div
          class="tab point"
          :style="'width:' + gameHotList.length * 160 + 'px'"
        >
          <span
            class="user-name"
            @click="
      ...
      <div class="tabs-wrapper" ref="tabsWrapper2">
        <div class="contain" :style="'width:' + itemList.length * 160 + 'px'">
          <div
            class="li point"
            ...
            <div v-if="item.hintImage || item.hintText">
              ...
              <div class="price">
                {{ currencyInfo.symbol
                  ...
                  (item.price && item.price * currencyInfo.rate).toFixed(2)
                }}
              </div>
            </div>
      ...
      <div class="contain">
        <div class="li">
          ...
          <div class="text-title">
            <div style="font-size: 16px; text-align: left;color:#fff">Secure Payment</div>
            <div class="text">
              100% secure online payment system proved by numerous users
            </div>
          </div>
        </div>
        <div class="li">
          ...
          <div class="text-title">
            <div style="font-size: 16px; text-align: left;color:#fff">Fast Delivery</div>
            <div class="text">
              More than 95% of orders are processed successfully in less than 30
              minutes.
            </div>
          </div>
        </div>
        <div class="li">
          ...
          <div class="text-title" >
            <div style="font-size: 16px; text-align: left;color:#fff">Refund Guaranteed</div>
            <div class="text">
              EGPAL ensures that buyers receive the item they ordered or get
              their money back.
            </div>
          </div>
        </div>
        <div class="li">
          ...
          <div class="text-title" >
            <div style="font-size: 16px; text-align: left;color:#fff">24/7 Live Chat</div>
				<div class="text" > Our service is ticking around the clock. Contact us anytime you need help. </div>
...
export default {
  ...
  computed: {
    ...mapState(["login", "showMoveImg", "currencyInfo", "clientSize"]),
  },
  methods: {
          ...
          if (response.retCode == 0) {
            ...
            this.newsList &&
              this.newsList.map((item) => {
                item.updated = this.$util.formatTime(
                  item.updated,
                  "YYYY-MM-DD HH:mm:ss"
                );
              });
      ...
      getTemplete("?type=Product&offset=-1&count=-1").then((response) => {
        if (response.retCode == 0) {
          this.itemList = response.data.filter((item) => {
		   ...
		   if (!this.scroll2) {
              this.scroll2 = new BScroll(this.$refs.tabsWrapper2, {
                scrollX: true,
                eventPassthrough: "vertical",
              });
            } else {
