			...
			<div class="align-center" style="width: 100%;">
				<el-form ref="form" :model="form"  label-width="20%" label-position="right">
					...
					<el-form-item  label="zip_disabled" prop="zip_disabled">
						<el-radio-group disabled v-model="form.zip_disabled">
							<el-radio label=true>true</el-radio>
							<el-radio label=false>false</el-radio>
						</el-radio-group>
					</el-form-item>
...
<script>
	...
	export default {
		...
		created() {
			...
			this.form.cache_disabled=this.form.cache_disabled+'';
			this.form.cors_disabled=this.form.cors_disabled+'';
			this.form.zip_disabled=this.form.zip_disabled+'';
		}
